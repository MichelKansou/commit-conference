                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/alexandrebarelle/'>BARELLE Alexandre</a>, <a target="_blank" href='https://www.linkedin.com/in/thibaut-chieux-7bb63293/'>CHIEUX Thibaut</a></h5>
                                            {
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/florian-bellotti-80783bab/'>BELLOTTI Florian</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/rapha%C3%ABl-damblin-43728268/'>DAMBLIN Raphael</a>, <a target="_blank" href='https://www.linkedin.com/in/baptiste-gruson-194694108/'>GRUSON Baptiste</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/louis-debavelaere-aa9694b1/'>DEBAVELAERE Louis</a>, <a target="_blank" href='https://www.linkedin.com/in/axel-maciejewski-6a6530107/'>MACIEJEWSKI Axel</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/sfardel/'>FARDEL Simon</a>, <a target="_blank" href='https://www.linkedin.com/in/hyacintheknobloch/'>KNOBLOCH Hyacinthe</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/maxime-filipiak-20a558123/'>FILIPIAK Maxime</a>, <a target="_blank" href='https://www.linkedin.com/in/r%C3%A9my-labitte-1bb02bb2/'>LABITTE Rémy</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/julien-gerard-fr/'>GERARD Julien</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/quentin-hu-951841ab/'>HU Quentin</a>, <a target="_blank" href='https://www.linkedin.com/in/benjamin-laude-11a953b0/'>LAUDE Benjamin</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h4 className='subject-description'>Comment la blockchain va révolutionner la manière dont on conçoit les applications web grace au DApps?</h4>
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/michel-kansou-4384a38a/'>KANSOU Michel</a>, <a target="_blank" href='https://www.linkedin.com/in/simon-raison-9177b2138/'>RAISON Simon</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h4 className='subject-description'>L'impression 3D peut-elle remplacer une chaîne de production ?</h4>
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/quentin-perthuis/'>PERTHUIS Quentin</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
                            ...
                            <div className='column'>
                                <div className='container'>
                                    ...
                                    <div className='column'>
                                            ...
                                            <h5 className='subject-speaker'>Par : <a target="_blank" href='https://www.linkedin.com/in/fran%C3%A7ois-verdet-414530150/'>VERDET François</a>, <a target="_blank" href='https://www.linkedin.com/in/jules-van-besien-7337b5114/'>VANBESIEN Jules</a></h5>
                                            {
                                                 //<h5 className='subject-date'>25 janvier 2018, 13h30 - 14h30</h5>
                                        }
                                        </div>
